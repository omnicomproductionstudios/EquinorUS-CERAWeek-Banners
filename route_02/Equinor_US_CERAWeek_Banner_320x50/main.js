...
function animate() {
  ...
  // tl.staggerTo(["#copy1a", "#copy1b"], 1, {autoAlpha:1,  clipPath: "inset(0% 0% 0% 0%)", ease: Power1.easeOut}, 0.5, '<');

  tl.to(".copy1Container", 1.5, { x: 0, ease: Power1.easeOut }, "+=0.5");

  tl.staggerTo(["#copy1a", "#copy1b"], 1, {autoAlpha:1,  clipPath: "inset(0% 0% 0% 0%)", ease: Power1.easeOut}, 0.6, '<');
