...
function animate() {
  ...
  tl.to(square, 0.5, { autoAlpha: 1, rotationY: 0, scaleX: 1, ease: "power1.out" }, "<+=1.8");
  tl.to(square, 0.5, { scale: 4, ease: "none" }, "<+=0.5");

  tl.to(".copy2Container", 1.5, { x:0, ease: Power1.easeOut}, '>');
  tl.staggerTo(["#copy2a", "#copy2b"], 0.5, {autoAlpha:1,  clipPath: "inset(0% 0% 0% 0%)", ease: Power1.easeOut}, 0.4, '<');
